...
$stmt = $conn->prepare("SELECT mb.id_usuario, m.tipo FROM miembro_membresia mm
...
exit(); // 🔥 IMPORTANTE: Evitar salida de datos adicionales
    ...
    if ($resultado) {
        ...
        enviarNotificacion($conn, $idUsuario, "El registro de tu membresía '$tipoMembresia' ha sido eliminado.");
    } else {
