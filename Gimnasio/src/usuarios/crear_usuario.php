    ...
    <main>
        ...
        <section class="form_container">
            ...
            <form action="crear_usuario.php" method="POST" class="form_general" onsubmit="return validarFormulario()">
                ...
                <input type="text" id="nombre" name="nombre" class="input-general" required value="<?php echo isset($_SESSION['form_data']['nombre']) ? htmlspecialchars($_SESSION['form_data']['nombre']) : ''; ?>">

                <label for="email">Email:</label>
                <input type="email" id="email" name="email" class="input-general" required value="<?php echo isset($_SESSION['form_data']['email']) ? htmlspecialchars($_SESSION['form_data']['email']) : ''; ?>">
