...
// Verificar que el usuario es usuario normal (no admin, ni monitor, ni miembro)
...
// Contar el total de notificaciones visibles
...
<main class="form_container">
    ...
    <?php else: ?>
        ...
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="user_notificaciones.php?page=<?php echo $page - 1; ?>" class="btn-general">Anterior</a>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                <a href="user_notificaciones.php?page=<?php echo $i; ?>" class="btn-general <?php echo $i === $page ? 'active' : ''; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>

            <?php if ($page < $total_pages): ?>
                <a href="user_notificaciones.php?page=<?php echo $page + 1; ?>" class="btn-general">Siguiente</a>
            <?php endif; ?>
        </div>
    <?php endif; ?>
</main>
